...
namespace Homework
{
    class Program
    {
        static void Main(string[] args)
        {
            /*
                Homework:
                Ev tapşırığında bir elektronik mağazanın satış sistemi yığılacaq. 
              onların necə yaradılacağına, neçə dənə inheritance alınacağına və s.qarışmıram.
              Laptop class'ında olacaq propertylər: 
                    Id, Barcode, Brand, Model, BuyPrice, SellPrice, OfferPrice, CPU, Ram, GraphicCard, 
                    CreateDate, CreateUser, EditDate, EditUser, IsDeleted, DeleteDate, DeleteUser;

              Tv class'ında olacaq propertylər:
              Id, Barcode, Brand, Model, BuyPrice, SellPrice, OfferPrice, IsSmartTv, HasHDMI, Resolution, 
              CreateDate, CreateUser, EditDate, EditUser, IsDeleted, DeleteDate, DeleteUser;

              Deməli burada 2 dənə ayrı class olacaq. Laptop və TV.Bunlar özü başqa base class və ya ortaq property'lərin olduğu 
              bir və ya bir neçə class'dan
             ...
             Eyni zamanda class'ın içində NewItem, NewItems, UpdateItem, DeleteItem methodları olacaq.
              ...
              -NewItems methodu təyin olunan zaman 1 parametr yazılacaq ancaq istifadə edilən yerdə istədiyim qədər 
              Tv və ya Laptop tipində fərqli
            ...
            sisteme elave olunub!" yazısı çıxsın. 

             Yalnız IsDelete true olan bir məhsulun barkodu təkrar başqa məhsul üçün əlavə oluna bilər.İşinizi asanlaşdırmaq
             üçün bunu check edən bir method
