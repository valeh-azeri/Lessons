    ...
    public partial class inital : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, new DateTime(2023, 6, 3, 16, 17, 19, 835, DateTimeKind.Local).AddTicks(8455), "Computer", 800m, 35m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreateDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 2, 2, new DateTime(2023, 6, 3, 16, 17, 19, 835, DateTimeKind.Local).AddTicks(8466), "T-Shirt", 50m, 400m, null });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CategoryId", "CreateDate", "Name", "Price", "Stock", "UpdateDate" },
                values: new object[] { 3, 3, new DateTime(2023, 6, 3, 16, 17, 19, 835, DateTimeKind.Local).AddTicks(8467), "Cat food", 25m, 1000m, null });

            migrationBuilder.InsertData(
                table: "ProductFeatures",
                columns: new[] { "Id", "Color", "CreateDate", "Heigth", "ProductId", "UpdateDate", "Width" },
